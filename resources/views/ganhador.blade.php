...
$provaAtual = DB::table('provas')->where('numero', $prova)->first();

$ganhador = DB::table('usuarios')->where('id', $provaAtual->ganhador)->first();

?>
<div class="congrats">
    <h1>Parabens {{$ganhador->nome}}!!!</h1>
    <h2>Vencedor da prova {{$provaAtual->nome}}</h2>
</div>
